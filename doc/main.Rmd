...
if(train.rf){
  ...
  time.rf.train.final.balanced <- system.time(random_forest_fit_final_balanced <- random_forest_train(dat_train_balanced_SMOTE, mtry = 308, tree_number = 500, node_size = 10))
...
if (run.presentation.day){
  ...
  # 
  # presentation_day_advanced_accu <- mean(info$label == rf_predicted_balanced)
