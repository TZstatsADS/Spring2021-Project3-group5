...
```{r exp_setup}
run.lda <- TRUE # run cross-validation on the training set
...
#rebalance the train and test data
...
save(balanced_test_data, file="../output/feature_balanced_train.RData")
```
